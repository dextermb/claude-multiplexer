...
A session gets `rename_session`, `list_sessions`, `list_inactive_sessions`,
`list_archived_sessions`, `get_messages`, `list_jobs`,
`get_config_path`, `get_bar_defaults`, `get_template_path`, `get_api_url`, `get_peer_url`, `get_api_docs`, `set_editor`, `unset_editor`,
