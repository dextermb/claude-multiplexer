...
func (b *bridge) SetPeerListen(addr string) (string, error) { return b.m.SetPeerListen(addr) }

func (b *bridge) UnsetPeerListen() (string, bool, error) { return b.m.UnsetPeerListen() }
